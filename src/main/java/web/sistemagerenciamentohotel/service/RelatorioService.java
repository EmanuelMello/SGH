...
public class RelatorioService {
	...
	public byte[] gerarRelatorioCompletoHotel() {
		logger.trace("Entrou em gerarRelatorioCompletoHotel");
		InputStream arquivoJasper = getClass().getResourceAsStream("/relatorios/RelatorioHotelCompleto.jasper");
