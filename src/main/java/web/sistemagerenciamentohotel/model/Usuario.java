...
import web.sistemagerenciamentohotel.service.NomeUsuarioUnicoService;
import web.sistemagerenciamentohotel.validation.UniqueValueAttribute;
...
public class Usuario implements Serializable {
	...
	@Id
	@SequenceGenerator(name="gerador555", sequenceName="usuario_codigo_seq", allocationSize=1)
	@GeneratedValue(generator="gerador555", strategy=GenerationType.SEQUENCE)
	private Long codigo;
